...
const AdminChallenges = () => {
  ...
  const handaleSave = () => {
    ...
    if (currentChallenge._id) {
      ...
      dispatch(
        createOneChallengeAdminThunk({
          challengesData: currentChallenge,
          accessToken,
        })
      );
    }
  ...
  const handleDelete = (challengeId) => {
    dispatch(deleteChallengeAdminThunk({ challengeId, accessToken }));
  };
      ...
      <Dialog open={openDialog} onClose={handleCloseDialog} fullWidth>
        ...
        <DialogContent>
          ...
          <TextField
            ...
            margin="normal"
            onChange={(e) =>
              setChallenges((prev) => ({ ...prev, difficulty: e.target.value }))
            }
          >
          ...
          <TextField
            ...
            onChange={(e) =>
              setCurrentChallenge((prev) => ({
                ...prev,
                tages: e.target.value.split(",").map((tag) => tag.trim()),
              }))
            }
          />
